...
1. Install fontforge if required for grunt-webfont on your OS.
   See [grunt-webfont installation
   instructions](https://github.com/sapegin/grunt-webfont/blob/master/Readme.md#installation)
   for details.
...
- Run the local development server: `grunt serve`


Using project-level meta data
=============================

The table of contents is generated from `site/_project.yaml`
...
The table of contents is generated from `site/_book.yaml`
