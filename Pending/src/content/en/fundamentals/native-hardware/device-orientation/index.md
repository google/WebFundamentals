...
# Device Orientation & Device Motion {: .page-title }
...
Caution: Not all browsers use the same coordinate system, and may report different values under identical situations. This has improved over time, but be sure to test your situation.
...
<tr>
  <td><code>Z</code></td>
  <td>represents an up-down direction, perpendicular to the ground
...
The rotation around the z axis and is 0&deg; when the top of
...
The rotation around the x axis and is 0&deg; when the top and
...
The rotation around the y axis and is 0&deg; when the left and
...
[`beta`](#beta), and [`gamma`](#gamma). On Mobile Safari, and additional parameter
...
`acceleration` and `accelerationWithGravity` is provided in m/sec<sup>2</sup>.
