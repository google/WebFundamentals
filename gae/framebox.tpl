...
<html>
  <head>
    ...
    <script src="https://developers.google.com/_static/js/prettify-bundle.js"></script>
    <meta name="robots" content="noindex,nofollow">
    <script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
    <script src="https://developers.google.com/_static/js/jquery_ui-bundle.js"></script>
    <script src="//www.google.com/jsapi?key=AIzaSyCZfHRnq7tigC-COeQRmoa9Cxr0vbrK6xw"></script>
    <script src="https://developers.google.com/_static/js/framebox.js"></script>
  </head>
