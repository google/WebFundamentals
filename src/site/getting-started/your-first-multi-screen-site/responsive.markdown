...
* [Enhance imgs with srcset for high DPI devices]({{site.baseurl}}/documentation/introduction-to-media/images/index.html#enhance-imgs-with-srcset-for-high-dpi-devices)
