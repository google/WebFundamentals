...
وعلى المستوى الداخلي، يحدد المتصفح 256 قيمة (ظلاً) لكل قناة، وبذلك تتم ترجمة 8 بت لكل قناة (28 = 256) و4 بايت لكل بكسل (4 قنوات × 8 بت = 32 بت = 4 بايت). ونتيجة لذلك، إذا كنا نعرف أبعاد الشبكة، فيمكننا بسهولة حساب حجم الملف:
