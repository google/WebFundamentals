...
![Alt text](/web/this/image/doesnt/exist.png "WF Logo")

![Alt text](https://developers.google.com/web/images/web-fundamentals-icon192x192.png "WF Logo")

<img src="yah-thats-not-here-either.png">
