...
introduction: "端末モーションは、特定の瞬間にデバイスに適用された アクセラレーション の力に関する情報と、回転速度の情報を提供します。"
article:
...
key-takeaways:
  devmotion: 
    ...
    - <code>acceleration</code> および <code>accelerationWithGravity</code> は
      m/sec<sup>2</sup> で提供されます。
    - ブラウザの実装の違いに注意してください。
---
