...
introduction: "The Command Line API contains a collection of convenience functions for performing common tasks: selecting and inspecting DOM elements, displaying data in readable format, stopping and starting the profiler, and monitoring DOM events."
article:
...
{% include modules/remember.liquid title="Note" list=page.remember.access %}
...
{% include modules/remember.liquid title="Note" list=page.remember.library %}
...
{% include modules/remember.liquid title="Note" list=page.remember.new-line %}
