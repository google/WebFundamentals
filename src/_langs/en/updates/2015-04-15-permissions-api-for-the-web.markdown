...
developers to check the state of a permission rather than having to remember
...
intended to be this single, standard way to check the permission state of an API.

# permissions.query()

Check the state of a permission using the permissions.query() method. This will
return a state of [granted (you have permission), denied (you are blocked from
