...
description: "Analicemos todo lo que tratamos y armemos un gran resumen."
introduction: "Analicemos todo lo que tratamos y armemos un gran resumen."
article:
...
[Web Starter Kit](//developers.google.com/web/starter-kit) incluye
respaldo para las opciones más comunes y es un buen punto de partida, pero si
está interesado en saber cómo es una implementación más completa, le presentamos una
parte del `<head>` del Web Starter Kit que expandimos con más etiquetas
`<meta>`:
