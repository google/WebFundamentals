...
introduction: "Erfahrungen für verschiedene Geräte zu kreieren ist nicht so schwer, wie es sich anhört. In diesem Leitfaden erstellen wir als Beispiel eine Produktzielseite für unseren <a href='https://www.udacity.com/course/cs256'>Kurs ``CS256: Für das mobile Web entwickeln``</a>, der auf sämtlichen Gerätetypen gut funktioniert."
article:
