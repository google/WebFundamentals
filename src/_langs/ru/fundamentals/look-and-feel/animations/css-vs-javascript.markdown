---
layout: article
title: "Сравнение анимации средствами CSS и JavaScript"
description: "Для создания анимации можно использовать CSS или JavaScript. Какой из вариантов выбрать и почему?"
introduction: "В Интернете есть два основных способа создания анимации: с помощью CSS и JavaScript. Какой из них следует выбрать? Это зависит от других характеристик вашего проекта, а также от того, каких эффектов вы стремитесь добиться"
article:
...
notes:
  ...
  setinterval:
    - В сети можно встретить публикации кода, в котором для анимации используется функция setInterval или setTimeout. Это ужасное решение, поскольку анимация не будет синхронизирована с частотой экрана и поэтому весьма велика вероятность появления дрожания и пропусков изображения. Использовать такой код нежелательно в любых ситуациях, а вместо него рекомендуется использовать функцию requestAnimationFrame, которая синхронизируется надлежащим образом.
...
{% link_sample _code/box-move-simple.html %}См. образец{% endlink_sample %}
...
{% link_sample _code/box-move-keyframes.html %}См. образец{% endlink_sample %}
...
{% link_sample _code/box-move-js.html %}См. образец{% endlink_sample %}
