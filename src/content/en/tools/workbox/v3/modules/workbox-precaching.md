...
[Demo](https://workbox-demos.firebaseapp.com/demo/workbox-precaching/) | [Reference Docs](http://localhost:8080/web/tools/workbox/v3/reference-docs/latest/workbox.precaching)
...
![Workbox precaching list to precached assets](../images/precaching-step-1.png)
...
![Workbox precaching update example](../images/precaching-step-2.png)
...
![Workbox precaching cleanup step](../images/precaching-step-3.png)
...
[PrecacheController](/web/tools/workbox/v3/reference-docs/latest/workbox.precaching.PrecacheController)
