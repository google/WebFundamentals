...
description: "Inspect and modify animations with the Chrome DevTools 
Animation Inspector."
...
key-takeaways:
  - "Capture animations by opening the Animation Inspector. It automatically
    detects animations and sorts them into groups."
  - "Inspect animations by slowing them down, replaying them, or viewing
    their source code."
