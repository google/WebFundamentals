...
included capturing a public key, called the `applicationServerKey` in the
subscription API.
...
* Your app should pass key to the server as an array of eight-bit unsigned
  integers.
* It's required by a spec called Voluntary Application Server Identification
