...
<p class="intro">
  ...
  be available. Without it, social sites will provide only basic information, 
  without images or other helpful information. 
</p>
...
In order to validate your markup on Facebook, you can use the
[Debugger](https://developers.facebook.com/tools/debug/)

### Learn more
To learn more about things you can attach to the post on Facebook, visit the
official [Open Graph Protocol](https://ogp.me) site.
...
By assigning the Twitter `id` to the value of `twitter:site`, Twitter embeds 
this information in the shared post so that people can easily engage with the
page owner.

<img src="imgs/twitter-card.png" srcset="imgs/twitter-card.png 1x, imgs/twitter-card-2x.png 2x" />

### Validate rich snippets
In order to validate your markup, Twitter provides a [Card Validator](https://dev.twitter.com/docs/cards/validation/validator)
