...
>You can learn more about VoiceOver at [its Wikipedia page](https://en.wikipedia.org/wiki/VoiceOver), and the WebAIM site also has [an excellent article](http://webaim.org/articles/voiceover/) that includes many keyboard shortcuts for operating VoiceOver and navigating within a page, and links to additional information.
