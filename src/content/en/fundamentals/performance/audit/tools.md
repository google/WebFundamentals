...
[coverage panel](https://umaar.com/dev-tips/121-css-coverage/){: .external}.)
...
<figure>
  <img src="images/task-manager.png" alt="Chrome Task Manager showing memory and CPU usage for
...
<figure>
  ...
  images/lighthouse-download-1000.png 1000w" alt="Chrome Lighthouse button for downloading reports">
</figure>
...
[Navigation Timing API](https://developer.mozilla.org/en-US/docs/Web/API/Navigation_timing_API){: .external}.

You may want to record data using one of the
[JavaScript performance APIs](https://developer.mozilla.org/en-US/docs/Web/API/PerformanceObserver){: .external}
...
[scripts to do the same](https://paul.kinlan.me/android-screen-recording/){: .external}).
...
If relevant, get a [Web Bloat Score](http://www.webbloatscore.com/){: .external}. This is a fun
test, but it can also be a compelling way to demonstrate code bloat — or to show you've
made improvements.

[What Does My Site Cost?](https://whatdoesmysitecost.com/test/170427_KK_6aecf8c8a21c22e9f59b2b65e8371569#gniCost){: .external},
...
<figure>
  ...
  images/site-cost-1000.png 1000w" alt="Screenshot from whatdoesmysitecost.com">
</figure>
