...
{% includecode content_path="web/fundamentals/design-and-ui/_code/media.html" region_tag="picture" adjust_indentation="auto" %}
</pre>
...
<pre class="prettyprint">
{% includecode content_path="web/fundamentals/design-and-ui/_code/sizes.html" region_tag="picture" adjust_indentation="auto" %}
</pre>
...
<pre class="prettyprint">
{% includecode content_path="web/fundamentals/design-and-ui/_code/breakpoints.html" region_tag="picture" adjust_indentation="auto" %}
</pre>
...
<pre class="prettyprint">
{% includecode content_path="web/fundamentals/design-and-ui/_code/conditional-mq.html" region_tag="conditional" adjust_indentation="auto" %}
</pre>
...
<pre class="prettyprint">
{% includecode content_path="web/fundamentals/design-and-ui/_code/image-set.html" region_tag="imageset" adjust_indentation="auto" %}
</pre>
...
<pre class="prettyprint">
{% includecode content_path="web/fundamentals/design-and-ui/_code/media-query-dppx.html" region_tag="mqdppx" adjust_indentation="auto" %}
</pre>
...
<pre class="prettyprint">
{% includecode content_path="web/fundamentals/design-and-ui/_code/icon-svg.html" region_tag="iconsvg" adjust_indentation="auto" %}
</pre>
...
<pre class="prettyprint">
{% includecode content_path="web/fundamentals/design-and-ui/_code/icon-font.html" region_tag="iconfont" adjust_indentation="auto" %}
</pre>
...
<pre class="prettyprint">
{% includecode content_path="web/fundamentals/design-and-ui/_code/image-sprite.html" region_tag="sprite" adjust_indentation="auto" %}
</pre>
