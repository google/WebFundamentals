...
<div class="wf-landing-section">
  <div class="page-content mdl-grid">
    ...
    <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
      ...
      <ul>
        <li><a href=".">Test with emulated low bandwidth and high latency</a></li>
  ...
  <div class="page-content mdl-grid">
    ...
    <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
      ...
      <ul>
        ...
        <li><a href=".">Avoid expensive animations</a></li>
        <li><a href=".">Avoid radio usage: eliminate unnecessary downloads</a></li>
        <li><a href=".">Reduce user actions required to access content</a></li>
        <li><a href=".">Use hardware acceleration</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="wf-landing-section wf-landing-gmp">
  <div class="page-content mdl-grid">
    <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet mdl-cell--hide-phone">
      ...
      <ul>
        <li><a href=".">Cater for a range of viewports and devices</a></li>
  ...
  <div class="page-content mdl-grid">
    ...
    <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet">
      ...
      <ul>
        ...
        <li><a href=".">Streamline forms</a></li>
