...
This feature was initially still somewhat experimental. So in order to keep from
prematurely baking this design in before it was fully specified and agreed upon,
we initially implemented this feature in Chrome 52 as an
...
The permission is automatically denied in all other cases. The goal is to ensure 
that users can rely on their favorite web apps and not find they have suddenly 
been cleared.
