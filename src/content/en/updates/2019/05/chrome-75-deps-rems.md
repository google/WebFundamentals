...
Practically speaking aren't used. Most developers use it accidentally, and typically when it is used, this property forces a new formatting context similar to setting "overflow: hidden".
