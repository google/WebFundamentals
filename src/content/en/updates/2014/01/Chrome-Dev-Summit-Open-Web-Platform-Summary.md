...
At [chromestatus.com](https://www.chromestatus.com/) you can see the [features](https://www.chromestatus.com/features) we've worked on, the features we've shipped, and those we're planning to deprecate. You can also check the [Chromium Releases blog](https://chromereleases.googleblog.com/){: .external }, which has links to bugs and to our tracker dashboard.
...
+ [Web Audio](https://www.html5rocks.com/en/tutorials/webaudio/intro/) provides sophisticated tools for audio synthesis and processing.
...
+ [Media Source Extensions](/web/updates/2011/11/Stream-video-using-the-MediaSource-API) can be used for adaptive streaming and time shifting.
+ EME enables playback of protected content.
+ Transcripts, captions and the [track element](https://www.html5rocks.com/en/tutorials/track/basics/){: .external } enable subtitles, captions, timed metadata,  deep linking and deep search.
