...
Chrome for Android, Linux and macOS behind an experimental flag. Go to
...
M53 as an [origin trial](https://github.com/jpchase/OriginTrials) for Chrome
OS, Android & macOS. To use this experimental API in Chrome with no flag,
...
At the time of writing, Chrome OS, Android M+, Linux and macOS are [the most advanced
