...
{# wf_featured_snippet: This article describes why and how we implemented color vision deficiency simulation in DevTools and the Blink Renderer. #}
...
<div class="video-wrapper-full-width">
  <iframe class="devsite-embedded-youtube-video" data-video-id="34iDTeCNTz4" allowfullscreen></iframe>
</div>
...
<picture>
  ...
  <source type="image/avif" srcset="/web/updates/images/2020/11/cvd/0-regular-2x.avif 2x, /web/updates/images/2020/11/cvd/0-regular.avif">
  <source type="image/webp" srcset="/web/updates/images/2020/11/cvd/0-regular-2x.webp 2x, /web/updates/images/2020/11/cvd/0-regular.webp">
...
The first change is the XML namespace declaration at the top. The second addition is the so-called “solidus” — the slash that indicates the `<feColorMatrix>` tag both opens and closes the element. This last change is not actually necessary (we could just stick to the explicit `</feColorMatrix>` closing tag instead), but since XML supports this `/>` shorthand (unlike HTML), we might as well make use of it.
