...
{# wf_featured_snippet: Chrome 86 is rolling out now! The file system access API is now available in stable. There are new origin trials for Web HID and the Multi-Screen Window placement API. There’s some new stuff in CSS, and plenty more. Let’s dive in and see what’s new for developers in Chrome 86! #}
