  ...
  sections:
    ...
    - title: Design
      content: |
        ...
        <p class="center">
          <img src="images/chrome-dev-summit/design_problem.jpg" alt="Design Problem" style="max-width: 300px;" />
        </p>
