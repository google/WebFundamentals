...
IOWA is a [single page application](https://en.wikipedia.org/wiki/Single-page_application) (SPA) that's built using [web components](http://webcomponents.org/), Polymer, Firebase, and has an extensive backend
...
the frontend. If you're interested in the full source code, [check it out](https://github.com/GoogleChrome/ioweb2016) on Github.
