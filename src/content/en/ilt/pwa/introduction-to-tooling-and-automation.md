...
{# wf_updated_on: 2017-01-25T22:32:00Z #}
{# wf_published_on: 2016-01-01 #}


# Introduction to Tooling and Automation {: .page-title }
...
Note: It is a best practice not to push packages to version control systems. It's better to use <code>npm install</code> and <strong>package.json</strong> to install project packages locally. 
...
Note that there is now a __devDependencies__ field with gulp and its current version listed.
