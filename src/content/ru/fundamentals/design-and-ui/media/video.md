...
<div class="mdl-grid">
  <div class="mdl-cell mdl-cell--6--col">
    <img class="center" alt="Скриншот Android Chrome, вертикальная ориентация: без постера" src="img/Chrome-Android-video-no-poster.png">
  </div>

  <div class="mdl-cell mdl-cell--6--col">
    <img class="center" alt="Скриншот Android Chrome, вертикальная ориентация: с постером" src="img/Chrome-Android-video-poster.png">
  </div>
</div>
...
<div class="mdl-grid">
  <img class="mdl-cell mdl-cell--6--col" alt="Скриншот Chrome для Android, вертикальная ориентация: немодифицированный элемент video превышает размеры области просмотра" src="img/Chrome-Android-portrait-video-unstyled.png">
    <img class="mdl-cell mdl-cell--6--col" alt="Скриншот Chrome для Android, горизонтальная ориентация: немодифицированный элемент video превышает размеры области просмотра" src="img/Chrome-Android-landscape-video-unstyled.png">
</div>
...
<div class="mdl-grid">
  <img class="mdl-cell mdl-cell--6--col" alt="Скриншот видеопроигрывателя в Safati на iPhone, вертикальная ориентация" src="img/iPhone-video-playing-portrait.png">
    <img class="mdl-cell mdl-cell--6--col" alt="Скриншот видеопроигрывателя в Safati на iPhone, горизонтальная ориентация" src="img/iPhone-video-playing-landscape.png">
</div>
