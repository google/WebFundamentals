...
<div class="wf-devtools-flex">
  ...
  <ol>
    ...
    <li>
<strong>明示的なパーセンテージ</strong> は、画像の DPI をテストする場合などに役立ちます。</li>
  </ol>
  </div>
  <div class="wf-devtools-flex-third">
...
**使い方**:[[**Network conditions**]](/web/tools/chrome-devtools/profile/network-performance/network-conditions#network-conditions) ドロワーでユーザー エージェントを設定することもできます。
