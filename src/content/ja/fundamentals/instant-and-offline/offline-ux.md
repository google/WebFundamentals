...
<figure>
  <img class="attempt-right" src="images/weather-app.png" alt="天気情報アプリの例。">
...
<figure>
  <img class="attempt-left" src="images/material-money-rates-out-of-date.png" alt="ニュースアプリの例。通常の状態の Tailpiece">
  <img class="attempt-right" src="images/material-money-rates-updated.png" alt="ニュースアプリの例。アップデートできる状態の Tailpiece">
  <figcaption class="clearfix" style="clear:both;">
...
<figure>
  <img class="attempt-left" src="images/tailpiece-normal.png" alt="読み込まれた記事の例">
