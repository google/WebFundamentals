...
We bouwen een website die werkt op verschillende schermformaten en uiteenlopende apparaten. In het [vorige artikel]({{site.WFBaseUrl}}{{page.article.previous.url}}) vormden we de informatiearchitectuur van de pagina en maakten we een basisstructuur.
