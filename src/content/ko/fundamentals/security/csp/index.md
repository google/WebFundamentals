...
서버에서 제공하는 _모든 것_을 맹목적으로 신뢰하는 대신,
...
<div class="attempt-right">
  <figure>
    <img src="images/csp-error.png" alt="콘솔 오류: 스크립트 'http://evil.example.com/evil.js'가 script-src 'self' https://apis.google.com">이라는 콘텐츠 보안 정책을 위반하므로 로드를 거부함
  </figure>
</div>
...
* **`'none'`** 은 예상할 수 있듯이 아무 것과도 일치하지 않습니다.
