...
위에 있는 데이터를 보면 2013년 1월부터 2014년 1월 사이에 일반적인 웹 사이트에서 사용자가 다운로드한 데이터량이 증가하였음을 알 수 있습니다. 물론 반드시 모든 사이트의 데이터 전송량이 같은 비율로 증가한 것은 아니며, 같은 양의 데이터를 다운로드 받아야 하는 것도 아닙니다. 그래서 분포 내에서 다른 분위수인 50번째(중간), 75번재, 90번째에 초점을 맞췄습니다.
