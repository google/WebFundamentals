...
* 연결된 파일, 이미지 스프라이트, 도메인 분할과 같은
 불필요한 HTTP/1.x 임시 방편을 제거합니다([HTTP/1.x에 맞게 최적화 참조](https://hpbn.co/optimizing-application-delivery/#optimizing-for-http1x)
.
