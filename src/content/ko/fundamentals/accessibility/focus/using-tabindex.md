...
`tabindex`는 어떤 요소에든 적용할 수 있습니다.&mdash;그러나
모든 요소에서 반드시 필요한 것은 아니며&mdash;다양한 정수값 범위를 취합니다. 
...
좋습니다. `tabindex`를 사용한다면 버튼, 탭, 드롭다운, 텍스트 필드
와 같이 사용자가 입력을 제공할 것으로 예상되는 요소인 사용자설정 대화형 컨트롤로 제한하세요.
...
컨트롤 수준에서 포커스를 관리해야 할 경우도 있습니다.&mdash; 예를 들어,
...
더 자세한 내용은 이 [샘플 코드](https://github.com/udacity/ud891/blob/gh-pages/lesson2-focus/07-modals-and-keyboard-traps/solution){: .external }를 살펴보고
