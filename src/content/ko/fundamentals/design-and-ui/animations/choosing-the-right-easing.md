...
CSS에서 `ease-out` 키워드로 지정된 방정식을 넘어, "공격성"의 범위에 드는 잘 알려진 ease-out 방정식 그룹이 있습니다. 빠른 ease-out 효과를 내려면 [Quintic ease-out](http://easings.net/#easeOutQuint)을 고려하십시오.


[Quintic ease-out 애니메이션을 참조하세요](https://googlesamples.github.io/web-fundamentals/fundamentals/design-and-ui/animations/box-move-quintic-ease-out.html){: target="_blank" .external }
...
다양한 ease를 시도해 보고 어느 것이 프로젝트의 개성과 일치하는지 확인하는 작업부터 시작하십시오. easing 유형의 전체 목록과 데모에 대해서는 [easings.net](http://easings.net)을 참조하세요.
