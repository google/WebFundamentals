...
주의: 사용자는 데이터 손실을 매우 싫어합니다. 데이터 손실이 발생하면 큰 슬픔에 빠질 수 있습니다.
...
범위 내에 있는 클라이언트 만 제어할 수 있습니다. 클라이언트가 "제어되면"
...
**그렇게 하지 마십시오!** 그것은 일반적으로 서비스 워커에 좋지 않습니다.
