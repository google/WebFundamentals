...
기기에서 페이지를 테스트해보십시오. 페이지 환경이 일관적으로 불량하다면, 해당 페이지는 
...
출발점으로 삼으십시오. 작업 관리자는 페이지가 현재 얼마나 많은 메모리를
사용하고 있는지 알려주는 실시간 모니터입니다.

1. <kbd>Shift</kbd>+<kbd>Esc</kbd>를 누르거나
Chrome 메인 메뉴로 이동하여 **More tools** > **Task manager**를 선택하면
작업 관리자가 열립니다.
...
힙을 나타냅니다. **Overview** 창 아래 **Counter** 창이 있습니다. 여기에서
메모리 사용량을 JS 힙(
...
모범 사례를 따르면, 첫 번째 하강 부분은 사실 **가비지 수집** 
...
노란색 노드를 클릭하면 더욱 심층적으로 조사할 수 있습니다. **Objects** 창
에서 이를 참조하는 코드에 대한 자세한 내용을 볼 수 있습니다. 예를 들어 
