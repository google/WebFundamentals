...
description:为您反复使用的命令行任务设置快捷键。如果您发现自己在命令行中反复键入相同的内容，这将为您带来很大方便。
...
为您反复使用的命令行任务设置快捷键。如果您发现自己在命令行中反复键入相同的内容，这将为您带来很大方便。


### TL;DR {: .hide-from-toc }
- 掌控命令行；创建易于记住和可快速键入的别名。
- 尝试保存、分享 Github 点文件，并同步您的命令行快捷键。


## 如何设置

创建命令行快捷键最简单的方法就是将常见命令的别名添加至 bashrc 文件。
在 Mac 或 Linux 上：
...
在 Github 上保存您的快捷键和点文件。主要好处是可以在各个设备之间分享快捷键，而且始终可以备份快捷键。
