...
# Incluir anuncios de AdSense en el sitio {: .page-title }
...
Note: - Las etiquetas <code>data-ad-client</code> y <code>data-ad-slot</code> serán únicas para cada anuncio que generes.
...
<!-- TODO: Verify note type! -->
Note: Pega todo el código de anuncio en la etiqueta <code>body</code>; de lo contrario, los anuncios no funcionarán.
