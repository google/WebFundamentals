...
Note: ஒரு பெயிண்ட் பணியிடம் சூழல் 100% `<canvas>` சூழல் போல அல்ல. இப்போது வரை, உரை ஒழுங்கமைவு முறைகள் காணவில்லை மற்றும் பாதுகாப்பு காரணங்களுக்காக நீங்கள் கேன்வாஸ் இருந்து பிக்சல்கள் மீண்டும் படிக்க முடியாது.
...
Note: இது வண்ணங்கள் அளவுருவமாக்க பெரும் இருக்கும், கூட, இல்லையா? `paint()` செயல்பாடு வாதங்களின் பட்டியலை எடுக்க அனுமதிக்கிறது. இந்த அம்சம் இன்னும் Chrome இல் நடைமுறைப்படுத்தப்படவில்லை, ஏனென்றால் ஹுடினியின் பண்புகள் மற்றும் மதிப்புகள் ஏபிஐ மீது அது பெரிதும் நம்பியுள்ளது, அது கப்பல் செல்லும் முன் இன்னும் சில பணிகள் தேவை.
...
Note: முறிப்புக்குறிப்புகள் தற்போது CSS பெயிண்ட் API இல் ஆதரிக்கப்படவில்லை, ஆனால் Chrome இன் வெளியீட்டில் வெளியிடப்படும்.
