---
layout: article
title: "Окончательная компоновка"
description: "Теперь давайте соберем вместе все то, что мы обсуждали, и посмотрим, как это будет выглядеть в одной форме"
introduction: "Теперь давайте соберем вместе все то, что мы обсуждали, и посмотрим, как это будет выглядеть в одной форме"
article:
...
Набор [Web Starter Kit](//developers.google.com/web/starter-kit), включающий средства поддержки
наиболее часто используемых параметров, станет прекрасной отправной точкой. Однако
если вам интересно, как выглядит более полная реализация, 
ниже показан фрагмент раздела `<head>` в Web Starter Kit, в который мы добавили 
дополнительные теги `<meta>`:
