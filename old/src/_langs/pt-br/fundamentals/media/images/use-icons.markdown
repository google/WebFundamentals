...
introduction: "Ao adicionar ícones em sua página, use ícones vetoriais (SVG, na sigla em inglês) sempre que possível ou, em alguns casos, use caracteres unicode."
authors:
  - petelepage
article:
