...
introduction: "يعد أسلوب الطباعة أمرًا أساسيًا للحصول على تصميم رائع وكذلك علامة تجارية وسهولة قراءة ووصول. تمكِّن خطوط الويب جميع ما سبق وأكثر أيضًا: يكون النص قابلاً للتحديد والبحث والتكبير/التصغير ومناسبًا للعرض مع نسبة DPI مرتفعة، مما يوفر عرضًا متناسقًا وحادًا للنص بغض النظر عن حجم الشاشة والدقة. تمثل خطوط الويب أهمية كبيرة للحصول على تصميم جيد، وانطباع مستخدم وأداء رائع."
article:
...
{% include modules/remember.liquid title="ملاحظة" list=page.notes.svg %}
...
{% include modules/remember.liquid title="ملاحظة" list=page.notes.zopfli %}
...
^
{% include modules/remember.liquid title="ملاحظة" list=page.notes.local-fonts %}
...
{% include modules/remember.liquid title="ملاحظة" list=page.notes.font-order %}
...
{% include modules/remember.liquid title="ملاحظة" list=page.notes.unicode-subsetting %}
...
<div class="quote">
  <div class="container">
    <blockquote class="quote__content g-wide--push-1 g-wide--pull-1 g-medium--push-1">عندما يتم تحديد وزن لا يتوفر وجه له، يتم استخدام وجه بوزن مجاور. وبشكل عام، يتم ترتيب الأوزان العريضة مع الوجوه التي تتضمن أوزانًا أثقل ويتم ترتيب الأوزان الخفيفة مع الوجوه التي تتضمن أوزانًا أخف.
...
{% include modules/remember.liquid title="ملاحظة" list=page.notes.synthesis %}
...
{% include modules/remember.liquid title="ملاحظة" list=page.notes.webfontloader %}
...
{% include modules/remember.liquid title="ملاحظة" list=page.notes.font-inlining %}
