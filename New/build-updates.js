...
/*
    ...
    Gets all of the updates and generates necessary index files, including:
    homepage, tocs, year indexes, RSS and ATOM feeds.
 */
...
function getAllMetadata(fileList) {
  console.log('Reading all update files...');
  var result = {};
